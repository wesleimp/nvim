...
local meta = {
  url = "https://github.com/wesleimp/nvim",
...
local is_cursor_under_typo = function(params)
  return function(typo)
    ...
    return params.row == typo.line_num
      and (params.col >= start_column and params.col < end_column)
  end
end
...
M.actions = {
  ...
  generator = null_ls.generator({
    ...
    on_output = function(params, done)
      ...
      local typos_under_cursor =
        vim.tbl_filter(is_cursor_under_typo(params), typos)
